...
window.DEFAULT_BOARDS = {
  "2": {
    ...
    components: [
      ...
      { id:'gpio', name:'GPIO Header (40-pin)', x:0.00, y:0.42, z:0,
      ...
      { id:'eth', name:'Ethernet Port', x:0.40, y:0.35, z:0,
      ...
      { id:'usb', name:'USB Ports (4x)', x:0.42, y:0.05, z:0,
      ...
      { id:'cpu', name:'BCM2837 — Quad-Core CPU', x:0.00, y:0.00, z:0,
      ...
      { id:'wifi', name:'BCM43438 — WiFi / BT', x:-0.32, y:0.30, z:0,
      ...
      { id:'power', name:'Micro-USB Power Input', x:-0.40, y:-0.38, z:0,
      ...
      { id:'d5', name:'D5 — TVS Diode (SMBJ5.0A)', x:-0.26, y:-0.22, z:0,
      ...
      { id:'hdmi', name:'HDMI Output', x:-0.05, y:-0.42, z:0,
